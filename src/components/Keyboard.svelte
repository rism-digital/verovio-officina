...
>
    <midi-player
        sound-font=""
        style="display: none;"
        src="data:audio/midi;base64,"
    ></midi-player>
    <div
        class="vrv-keyboard-navigator"
        style="background-image: url(&quot;https://editor.verovio.org/icons/keyboard/left.png&quot;);"
        data-app-el-id="66ab97704a7e8000"
    ></div>
    <div class="vrv-keyboard-wrapper">
        <div class="vrv-keyboard-octaves">
        ...
        <div class="vrv-keyboard-keys" data-app-el-id="27e293eda8b10000">
            ...
            <div
                class="vrv-keyboard-key white selected"
                data-midi="36"
                data-key="A"
            ></div>
            <div
                class="vrv-keyboard-key black selected"
                data-midi="37"
                data-key="W"
            ></div>
            <div
    ...
    <div
        class="vrv-keyboard-navigator"
        style="background-image: url(&quot;https://editor.verovio.org/icons/keyboard/right.png&quot;);"
        data-app-el-id="d612e0ff45e42000"
    ></div>
</div>
